...
class N64TechDemo:
    ...
    def setup_screen(self):
        ...
        self.screen.title("N64 TECH DEMO - Super Mario 64 Castle v1.0")
    ...
    def draw_castle(self):
        ...
        # Main keep
        self.draw_rectangle(castle, -100, -150, 200, 250, "#FFE4B5")
        self.draw_triangle_roof(castle, -120, 100, 240, "#DC143C")
        
        # Left tower
        self.draw_rectangle(castle, -250, -150, 120, 200, "#FFE4B5")
        self.draw_triangle_roof(castle, -265, 50, 150, "#DC143C")
        
        # Right tower
        self.draw_rectangle(castle, 130, -150, 120, 200, "#FFE4B5")
        self.draw_triangle_roof(castle, 115, 50, 150, "#DC143C")
        
        # Windows (interactive elements)
        self.draw_window(castle, -60, 0, 30, "#ADD8E6")
        self.draw_window(castle, 30, 0, 30, "#ADD8E6")
        
        # Castle door
        if self.castle_door_open:
            self.draw_arch(castle, -40, -150, 80, 80, "#000000")  # Open door
        else:
            self.draw_arch(castle, -40, -150, 80, 80, "#8B4513")  # Closed door
    ...
    def create_collectibles(self):
        ...
        # Create stars
        star_positions = [(-200, -180), (200, -180), (0, 50), (-180, 0), (180, 0)]
        ...
        for _ in range(10):
            ...
            coin.color("yellow")
            coin.penup()
            coin.goto(random.randint(-350, 350), random.randint(-190, 200))
            coin.shapesize(0.5, 0.5)
            self.coins.append(coin)
            
    def move_player(self, direction):
        """Move the player character."""
        if direction == 'left' and self.player_x > -380:
            self.player_x -= self.player_speed
        elif direction == 'right' and self.player_x < 380:
            self.player_x += self.player_speed
        elif direction == 'up' and self.player_y < 250:
    ...
    def check_collisions(self):
        ...
        if -40 < self.player_x < 40 and self.player_y < -130:
    ...
    def demo_movement(self):
        ...
        if self.demo_mode:
            ...
            self.player_x = 200 * math.sin(self.frame_count * 0.02)
            # Occasional jumps
    ...
    def demo_complete(self):
        ...
        complete.goto(0, 100)
        complete.color("gold")
        complete.write("DEMO COMPLETE!", align="center", font=("Arial", 30, "bold"))
        complete.goto(0, 50)
        complete.write(f"Stars: {self.collected_stars}/5", align="center", font=("Arial", 20, "normal"))
        complete.goto(0, 20)
        complete.write(f"Coins: {self.collected_coins}", align="center", font=("Arial", 20, "normal"))
        complete.goto(0, -30)
        complete.color("white")
        complete.write("Thanks for playing!", align="center", font=("Arial", 16, "normal"))
        complete.goto(0, -60)
        complete.write("SGI/N64 Tech Demo v1.0", align="center", font=("Arial", 12, "italic"))
